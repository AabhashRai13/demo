...
WishListProducts productsFromJson(String str) =>
    WishListProducts.fromJson(json.decode(str));

String productsToJson(WishListProducts data) => json.encode(data.toJson());
...
class WishListProducts {
  ...
  factory WishListProducts.fromJson(Map<String, dynamic> json) => WishListProducts(
    count: json["count"],
    next: json["next"],
