...
import 'package:bees_pharmacy/widgets/homeWidget/similarwidget.dart';
...
class DetailPage2View extends GetView<DetailPage2Controller> {
  final DetailPage2Controller detailPageController =
      Get.put(DetailPage2Controller());
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    cartController.insert(
                        ...
                        detailPageController.variant[0].price,
