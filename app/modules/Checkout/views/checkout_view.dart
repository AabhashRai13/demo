                        ...
                        children: [
                            ...
                            child: TextFormField(
                              ...
                              controller: checkoutController.numberController
                                ..text = checkoutController
                                    .accountProfileDetail.contactNumber,
                              style: TextStyle(
                                color: Colors.black,
                              ),
                          ...
                          input(
                              Icon(Icons.place_outlined,
                                  color: Colors.blue, size: 18),
                              "Billing Address",
                              checkoutController.billingAddressController
                                ..text = checkoutController
                          ...
                          input(
                              Icon(Icons.place_outlined,
                                  color: Colors.blue, size: 18),
                              "Shipping Address",
                              checkoutController.shippngAddrerssController
                                ..text = checkoutController
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    //     ),
                    //     Text(
                    //       'Rs.' + checkoutController.totalPrice.toString(),
                    //       style: TextStyle(
                    //         color: Colors.white,
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        controller: textEditingController
          ..text = checkoutController.accountProfileDetail.email == null
              ? ''
              : checkoutController.accountProfileDetail.email,
        style: TextStyle(
          color: Colors.black,
        ),
        decoration: InputDecoration(
